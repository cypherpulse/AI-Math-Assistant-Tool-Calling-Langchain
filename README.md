...
This repository contains a hands-on Jupyter Notebook lab that demonstrates how to build an AI-powered math assistant using LangChain's tool calling feature. The assistant enables natural language interaction for performing basic arithmetic operations, breaking down complex queries into executable steps.
...
- Create custom tools for specific mathematical tasks
